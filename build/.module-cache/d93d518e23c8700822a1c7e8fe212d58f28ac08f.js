    ...
    if (this.state.showAll) {
      return(
        React.createElement("div", {onClick: this.handleClick}, 
          ...
          React.createElement("div", {className: "col-sm-8 col-md-offset-2"}, 
            React.createElement(ProjectColumn, {classList: "col-sm-6 col-md-6", projects: projectColumn1}), 
            React.createElement(ProjectColumn, {classList: "col-sm-6 col-md-6", projects: projectColumn2})
          )
        )
      )
    } else {
