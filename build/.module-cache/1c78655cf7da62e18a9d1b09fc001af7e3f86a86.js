    ...
    return (
      React.createElement("div", {className: this.props.classList}, 
        projects.map(function(project) {
          return React.createElement(Project, {key: project.id, data: project, onClick: handleClick})
        })
      )
    );
  }
...
var ProjectDisplay = React.createClass({displayName: "ProjectDisplay",
  ...
  handleClick: function(event) {
    this.setState({showAll: this.props.key ? this.props.key : false });
  },
  render: function() {
    if (this.state.showAll) {
      return(
        React.createElement("div", {onClick: this.handleClick}, 
          ...
          React.createElement(ProjectColumn, {classList: "col-sm-6 col-md-4 col-md-offset-2", projects: projectColumn1, handleClick: this.handleClick}), 
          React.createElement(ProjectColumn, {classList: "col-sm-6 col-md-4", projects: projectColumn2, handleClick: this.handleClick})
        )
      )
    } else {
      return React.createElement(ProjectDetail, {onClick: this.handleClick})
    }
  }
})
