...
- For each copy, git lets you review and "stage" only the changes you wish to keep. Then you push the changes to the master.  The master file updates with the new changes and becomes a new "version" of the project. Then you review the next friend's edits, and repeat until you've integrated all changes that you want.
